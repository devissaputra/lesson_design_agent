...
The four visuals in this folder were created specifically for **Lesson Design Agent** and are stored locally with the repository. They use no stock-image service or external image host.
